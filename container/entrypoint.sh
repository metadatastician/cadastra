...
cleanup() {
    echo "Received shutdown signal — stopping cadastra..."
...
# Examples:
#   exec /app/cadastra
#   exec /app/release/bin/cadastra start
#   exec /app/cadastra serve --host "${APP_HOST}" --port "${APP_PORT}"
