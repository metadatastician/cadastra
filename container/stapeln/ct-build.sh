...
#
# Cadastra — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: cadastra-release)
...
CT_KEY_ID="${CT_KEY_ID:-cadastra-release}"
...
echo "=== Cadastra Cerro Torre Build Pipeline ==="
