...
image:https://sonarcloud.io/api/project_badges/measure?project=metadatastician_cadastra&metric=alert_status[SonarQube Quality Gate,link="https://sonarcloud.io/summary/new_code?id=metadatastician_cadastra"]
