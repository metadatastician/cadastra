...
cookbook:
    ...
    echo "= cadastra Justfile Cookbook" > "$OUTPUT"
...
man:
    #!/usr/bin/env bash
    mkdir -p docs/man
    cat > docs/man/cadastra.1 << EOF
    .TH cadastra 1 "$(date +%Y-%m-%d)" "{{version}}" "cadastra Manual"
    .SH NAME
    cadastra \- RSR-compliant project
    .SH SYNOPSIS
    .B just
    [recipe] [args...]
    .SH DESCRIPTION
    ...
    EOF
    echo "Generated: docs/man/cadastra.1"
