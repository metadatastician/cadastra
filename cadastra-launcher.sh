...
# @a2ml-metadata begin
# (
#   id                   = "cadastra-launcher"
#   type                 = "launcher"
#   version              = "0.1.0"
#   app-name             = "cadastra"
#   app-display          = "Cadastra"
#   app-url              = ""
...
#
# ============================================================================
# cadastra-launcher.sh — Cadastra
# ============================================================================
# GENERATED by launch-scaffolder from cadastra.launcher.a2ml.
...
APP_NAME="cadastra"
APP_DISPLAY="Cadastra"
APP_DESC="Canonical register and survey of the hyperpolymath estate"
APP_CATEGORIES="Development;Utility;"
APP_GENERIC_NAME="Cadastra"
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/cadastra/cadastra.launcher.a2ml"

URL=""


PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/cadastra.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/cadastra/cadastra.log"

# Search list from [runtime].startup-command-search — first executable wins.
START_COMMAND=""
for candidate in \
    "/target/release/cadastra" \
    "/cadastra" \
    "cadastra" \
    ; do
    if [ -x "$candidate" ]; then
...
[runtime].startup-command-search or [runtime].command in cadastra.launcher.a2ml."
            return 1
        fi
    fi
