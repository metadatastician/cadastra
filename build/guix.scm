...
;;
;; Guix package definition for Cadastra
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace Cadastra and customize inputs for your language/stack.
...
(package
  ...
  (synopsis "Canonical register and survey of the hyperpolymath estate: houses the estate-migration-toolkit and its triage reports.")
