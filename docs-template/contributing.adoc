...
// SPDX-FileCopyrightText: 2026 Jonathan D.A. Jewell (metadatastician) <j.d.a.jewell@open.ac.uk>
= Contributing — Cadastra
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Cadastra`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/Cadastra.git
cd Cadastra
...
* Bugs in `Cadastra`: file at `metadatastician/Cadastra/issues`.
